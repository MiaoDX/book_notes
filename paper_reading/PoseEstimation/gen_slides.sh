pandoc -f markdown -t revealjs --self-contained PoseEstimationLearning.md -o PoseEstimationLearning.html -V theme=serif2 -V revealjs-url=H:/class_material/hand_in_homework/pandoc_markdown_revealjs/reveal.js -i
